...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
     volume_of_cube1 = volume_of_cube(10)
     assert_equal( 1000, volume_of_cube1 )
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    volume_of_sphere1 = volume_of_sphere(10)
    assert_equal( 4188.790204786391, volume_of_sphere1)
  end
  #
  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    hot_far_to_cel = fahrenheit_to_celsius(300)
    assert_equal( 148, hot_far_to_cel)
  end
